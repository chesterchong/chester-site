  ...
  useEffect(() => {
    ...
    const handleKeyDown = (e) => {
      ...
      if (key === "h") {
        ...
        e.preventDefault();
        runCommand(() => window.open("https://x.com/cheetah1118", "_blank"));
      } else if (key === "l") {
        e.preventDefault();
        runCommand(() =>
          window.open("https://www.linkedin.com/in/chesterch/", "_blank")
        );
      } else if (key === "g") {
        e.preventDefault();
        runCommand(() => window.open("https://github.com/chesterchong", "_blank"));
      } else if (key === "e") {
        e.preventDefault();
        runCommand(() =>
              ...
              >
                ...
                <Command.Item
                  ...
                  onSelect={() =>
                    runCommand(() =>
                      window.open(
                        "https://www.linkedin.com/in/chesterch/",
                        "_blank"
                      )
                    )
                  }
